...
2. **Quality Control** — compute quality metrics, detect doublets, and filter low-quality cells
...
if state.has_adata():
    ...
    if not state.qc_is_computed():
        next_page_button("Quality Control", "pages/02_QC.py")
